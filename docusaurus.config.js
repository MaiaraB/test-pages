...
const config = {
  ...
  organizationName: 'MaiaraB', // Usually your GitHub org/user name.
  projectName: 'test-pages', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} FC Data Platform`,
      },
      prism: {
